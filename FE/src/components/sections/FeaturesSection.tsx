  ...
  const features = [
    {
      ...
      description:
        "Every bottle is made from recycled materials, reducing waste and environmental impact.",
    ...
    },
    {
      ...
      title: "BPA-Free & Safe",
      description:
        "All our bottles are completely BPA-free and safe for daily use by the whole family.",
      color: "text-blue-500",
    ...
    },
    {
      ...
      description:
        "Advanced sealing technology ensures your drinks stay where they belong.",
      color: "text-cyan-500",
    ...
    },
    {
      ...
      description:
        "Even our packaging is sustainable, using biodegradable and recyclable materials.",
    ...
    },
    {
      ...
      description:
        "We offset all shipping emissions to ensure your purchase is truly eco-friendly.",
      ...
      <Container>
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            We&apos;re committed to creating the most sustainable and
            high-quality water bottles that make a positive impact on our
            planet.
          </p>
        </motion.div>
        ...
        >
          <Card className="max-w-4xl mx-auto p-8 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-green-200 dark:border-green-700">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
              Every purchase helps reduce plastic waste and supports sustainable
              manufacturing practices. Make a difference with every sip.
            </p>
            <motion.div
